...
# -*- coding: utf-8 -*-
"""
Рабочая конфигурация Nginx - используем правильный приоритет location блоков
"""
...
def main():
    print("="*60)
    print("РАБОЧАЯ КОНФИГУРАЦИЯ NGINX")
    print("="*60)
    ...
    try:
        # Используем точное совпадение и правильный приоритет
        nginx_config = """server {
    listen 80;
...
server {
    ...
    # Статические assets - используем ^~ для максимального приоритета
    location ^~ /app/assets/ {
        # rewrite для правильного пути
