#!/usr/bin/env python3
"""
Исправление ошибки в Services.tsx
"""
...
def main():
    print("="*60)
    print("ИСПРАВЛЕНИЕ ОШИБКИ В SERVICES.TSX")
    print("="*60)
    ...
    try:
        ...
        print("\n1. Загружаю исправленный Services.tsx...")
        upload_file(sftp, 'template/src/pages/Services.tsx', '/root/shannon/template/src/pages/Services.tsx')
        ...
        print("ГОТОВО!")
        print("="*60)
        print(f"\nОткройте: https://{SSH_HOST}/home/services")
        print("Ошибка должна быть исправлена!")
