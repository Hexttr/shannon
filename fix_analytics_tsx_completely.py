...
# Правильное содержимое файла Analytics.tsx
ANALYTICS_TSX_CONTENT = '''import { useState, useMemo } from 'react';
...
def main():
    ...
    try:
        ...
        remote_path = '/root/shannon/template/src/pages/Analytics.tsx'
        
        print(f"[INFO] Загрузка исправленного файла {remote_path}...")
        
        # Записываем файл
        with sftp.file(remote_path, 'w') as f:
            f.write(ANALYTICS_TSX_CONTENT)
