...
# -*- coding: utf-8 -*-
"""
Принудительное выполнение миграции personal_access_tokens
"""
...
def main():
    ...
    try:
        # 1. Удаление из таблицы migrations
        print("1. УДАЛЕНИЕ ЗАПИСИ О МИГРАЦИИ:")
        ...
        if "INTEGER" in output or "integer" in output.lower():
            ...
            print("  [WARNING] Проверьте структуру")
