...
# -*- coding: utf-8 -*-
"""
Тестирование прямой конфигурации Nginx
"""
...
def main():
    print("="*60)
    print("ТЕСТИРОВАНИЕ ПРЯМОЙ КОНФИГУРАЦИИ NGINX")
    print("="*60)
...
server {
    ...
    # Статические assets
    location /app/assets/ {
        # Используем root, поэтому путь будет root + location
        # root /root/shannon/template/dist + /app/assets/ = /root/shannon/template/dist/app/assets/
        # Но нам нужно /root/shannon/template/dist/assets/
        # Поэтому используем rewrite
